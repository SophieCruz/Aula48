class Game {
  ...
  start() {
    ...
    car1.scale = 0.07;
    // 2. Adicione a imagem para os carros
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        // altere a imagem do carro quando a vida do jogador for 0
  ...
  handlePlayerControls() {
    // Ative o controle do jogador apenas se a explosão for falsa
    if (!this.blast) {
  ...
  // Adicione a mensagem para exibir “Game Over” (Fim de Jogo) no console.
  end(){
